...
paper-style evaluation of RED fusion under known, unknown, and mis-specified
track correlations.
...
The workflow expects the unknown-correlation fusion patch to be present, i.e. it
expects `run_red_unknown_corr_experiment.py` and
`Filters/fusioncenter_unknowncorr.py` for the full tracking benchmark. The
controlled benchmark is standalone and implements the full method table:
